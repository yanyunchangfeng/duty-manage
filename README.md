<p align="center">
    <img width="300" src="src/assets/yanyunchangfeng.png">
</p>
...
## duty-manage  
  ...
  排班管理是一个基于angular + primeng 开发的排班管理系统,分为处室排班和指挥中心排班两大模块。

## 知乎专栏讲解链接

 * [自动排班算法的设计与实现(日历算法)](https://zhuanlan.zhihu.com/p/63495549)

## 演示地址

* [duty-manage](https://yanyunchangfeng.gitee.io/duty-manage)  
